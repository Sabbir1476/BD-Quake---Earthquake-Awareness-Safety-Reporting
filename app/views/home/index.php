    ...
    <div class="container">
        ...
        <div class="hero-subtitle mt-3">
            <?php if (isset($total_users)) : ?>
                <div class="mt-2" style="font-size:0.9rem; color:#9ca3af;">
    ...
    <div class="container">
        <div class="row g-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=report&action=create">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=shelter&action=index">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=forum&action=index">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=felt&action=index">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=guideline&action=index">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card-custom home-card-link"
                     role="link" tabindex="0"
                     data-href="<?= BASE_URL ?>/index.php?controller=info&action=faq">
...
document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.home-card-link').forEach(function (card) {
